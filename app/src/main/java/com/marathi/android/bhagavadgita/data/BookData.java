package com.marathi.android.bhagavadgita.data;

import android.text.TextUtils;

import com.marathi.android.bhagavadgita.App;
import com.marathi.android.bhagavadgita.R;
import com.marathi.android.bhagavadgita.helpers.JSONResourceReader;
import com.marathi.android.bhagavadgita.models.Book;
...
public class BookData {
  ...
  private static ArrayList<ChapterSection> hydrateChapterSections(Chapter chapter) {
    ...
    int sectionCount = 0;
    for (com.marathi.android.bhagavadgita.models.Section section : chapter.getSections()) {
